...
const ProfilePage: React.FC = () => {
  ...
  try {
    const res = await fetch("https://swapbox-back.onrender.com/api/user/", {
      headers: {
 ...
 // Use avatar from backend
  ...
  const fetchItems = async () => {
    try {
      const res = await fetch("https://swapbox-back.onrender.com/api/user-items/", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  try {
    const response = await fetch("https://swapbox-back.onrender.com/api/user/avatar/", {
      method: 'PATCH',
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  ? (profileImage.startsWith('http') ? profileImage : `https://swapbox-back.onrender.com${profileImage}`)
  ...
  const handleLike = async (itemId: number, liked: boolean) => {
    ...
    const url = liked
      ? `https://swapbox-back.onrender.com/api/items/${itemId}/unlike/`
      : `https://swapbox-back.onrender.com/api/items/${itemId}/like/`;
  ...
  try {
    const response = await fetch(`https://swapbox-back.onrender.com/api/items/${id}/`, {
      method: 'DELETE',
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  const handleSubmitComment = async (id: number) => {
    ...
    try {
      const res = await fetch(`https://swapbox-back.onrender.com/api/items/${id}/comments/`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'

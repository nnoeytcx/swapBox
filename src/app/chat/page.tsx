...
const ChatPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchChats = async () => {
      const res = await fetch("https://swapbox-back.onrender.com/api/chat/", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleChatSelect = async (chatId: number) => {
    ...
    const token = localStorage.getItem('jwt_access');
    const res = await fetch(`https://swapbox-back.onrender.com/api/chat/${chatId}/messages/`, {
  ...
  const token = localStorage.getItem('jwt_access');
  const res = await fetch(`https://swapbox-back.onrender.com/api/chat/${selectedChatId}/message/`, {
    method: "POST",
    headers: {
